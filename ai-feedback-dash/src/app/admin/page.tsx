          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2.5">
              ...
              <div className="hidden sm:block">
                ...
                <span className="text-xs text-[var(--text-muted)] block -mt-0.5">Admin Dashboard</span>
              </div>
              <span className="sm:hidden text-base font-bold text-[var(--text-primary)]">Admin</span>
            </div>
          </div>
        </div>
      </nav>
